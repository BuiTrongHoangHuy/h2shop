...
export default function AddCategoryModal({ isOpen, onClose, onSubmit, categories }: AddCategoryModalProps) {
  ...
  // Get parent categories (categories with no parent or active status)
  const parentCategories = categories.filter((cat) => cat.status === 1)
